...
import {BsPerson, BsCodeSlash, BsBriefcaseFill} from "react-icons/bs";
...
const Nav = () => {
  ...
  return (
    <nav className={navbarblur? 'Navbar blur':'Navbar'}> 
        ...
        <h1 title='Reload' onClick={()=>window.location.reload(true)} className='Logo'>SD</h1>
        ...
        <ul className='NavbarLinks'>
            ...
            <li onClick={hideMenu}><Link to="/Experience"><BsBriefcaseFill/> Experience</Link></li>
